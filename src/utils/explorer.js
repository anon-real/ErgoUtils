...
// utils contract protocol with time extending functionality
...
// utils contract protocol with fixed end-time
...
export const allAuctionTrees = activeAuctionAddresses // array of trees of all utils addresses until now.
