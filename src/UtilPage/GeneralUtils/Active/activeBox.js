...
import {auctionWithExtensionTree, getSpendingTx} from '../../../utils/explorer';
import PlaceBidModal from './placeBid';
import MyBidsModal from './myBids';
import BidHistory from './bidHistory';
import {getP2s} from "../../../utils/assembler";
...
export default class ActiveBox extends React.Component {
    ...
    openBid() {
        ...
        if (!isWalletSaved()) {
            ...
            showMsg(
                'This utils is finished! It is pending for withdrawal; If you configure your wallet, the app can use it to withdraw finished auctions.',
                true
            );
        } else {
            this.setState({ bidModal: !this.state.bidModal });
